...
<head>
  ...
  <title>Mobile Strapping Machine | Rental or hire - Dubai | UAE </title>

  <meta name="description" content="Mobile Strapping Equipment & Machines for Rental in Dubai, UAE. Yes Automation the leading company provides the best machinery Rental service in UAE.">

  <link rel="shortcut icon" href="images/favicon.png">

  <meta charset="utf-8">

  <meta name="keywords" content="Mobile Strapping Rental, Mobile Strapping Rental in UAE, Mobile Strapping Machines for Rental, Mobile Strapping Equipments for Rental, Mobile Strapping Machine Hire, Mobile Strapping Machine Hire in UAE">
  ...
  <section id="machinery-banner">
    ...
    <ul id="banner">
      ...
      <li>
        ...
        <img src="images/mobile-str-1.jpg" alt=" Mobile Strapping Rental">
      ...
      <li>
        ...
        <img src="images/mobile-str-2.jpg" alt=" Mobile Strapping Rental in UAE">
      ...
      <li>
        ...
        <img src="images/mobile-str-3.jpg" alt=" Mobile Strapping Rental in Dubai">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-xl-3 col-lg-3 col-md-4">
          <div class="back-it">
            ...
            <div id="download">
              ...
              <a href="pdf/Ergopack.pdf" class="box" download><i class="demo-icon icon-pdf">&#xe811;</i> Ergopack</a>
        ...
        <div class="col-xl-9 col-lg-9 col-md-8 video-f">
          ...
          <h2 style="text-transform: uppercase;" id="product-tittle">Mobile Strapping Machine</h2>



          <p>The mobile strapping system that is available with us on rental basis is manufactured by our principals Ergopack, Germany. These systems consist of different sized pallets that can safely, and comfortably be strapped with plastic straps – standing upright, without bends and walking around the pallet.</p>

          <h3>Uses</h3>
          <ul class="li-2">
            <li>Shipping Industries</li>
            <li>Logistics Divisions</li>
          </ul>
          <p>Due to its full mobility, a single staff can operate the machine instead of two or three staff. The patented Chain Lance guides the strap below the pallet, upwards at the opposite side, and directly into the hands of the user. The work is faster and easier with less burden; we recommend this is the best machine to serve your strapping needs.
            Quality mobile strapping machines are available for daily, weekly, and monthly rentals.</p>
          ...
          <div class="row top">
            ...
            <div class="col-md-6">
              ...
              <iframe height="315" src="https://www.youtube.com/embed/sdVfVvgHfBY" allow="autoplay; encrypted-media" allowfullscreen></iframe>

            </div>

            <div class="col-md-6">

              <iframe height="315" src="https://www.youtube.com/embed/t1ITx6lJpng" allow="autoplay; encrypted-media" allowfullscreen></iframe>
          ...
          <div class="row top">
            ...
            <div class="col-md-12">
              ...
              <iframe height="400" src="https://www.youtube.com/embed/SZEPGeaOni8" allow="autoplay; encrypted-media" allowfullscreen></iframe>
          ...
          <div class="row top">
            ...
            <div class="col-md-12">
              <p>For any rental requirements for mobile strapping machine, please <a class="cont" href="contact.php">contact us.</a> </p>
            </div>
