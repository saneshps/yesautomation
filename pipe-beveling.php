...
<head>
  ...
  <title>Pipe Cutting | Beveling | Duct Welding Machines for Rent UAE</title>

  <meta name="description" content="Pipe Cutting, Duct Welding, or Beveling Equipment & Machines for rental or hire in Dubai, UAE. YES Automation provides the best machinery Rental service in UAE.">
  ...
  <section id="machinery-banner">
    ...
    <ul id="banner">
      ...
      <li>
        ...
        <img src="images/pipe-bl-1.jpg" alt=" Duct Welding Machines Rental in UAE" />
      ...
      <li>
        ...
        <img src="images/pipe-bl-2.jpg" alt=" Pipe Beveling Machines Rental in UAE" />
      ...
      <li>
        ...
        <img src="images/pipe-bl-3.jpg" alt="Pipe Cutting Rental" />
      ...
      <li>
        ...
        <img src="images/pipe-bl-4.jpg" alt="Pipe Cutting Rental in UAE" />
      ...
      <li>
        ...
        <img src="images/pipe-bl-5.jpg" alt="Duct Welding Machines for rental" />
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-xl-9 col-lg-9 col-md-8">
          ...
          <h2 style="text-transform: uppercase;" id="product-tittle">Pipe Beveling</h2>



          <p>Yes Automation offers <strong>Tri Tool’s</strong> Pipe cutting & Beveling equipment on Rental. </p>



          <p>Tri Tool is the world's premier precision and portable machine tool manufacturing company that builds high-quality, precision tools for pipe, tube & welding machines. These machines from Tri Tools offer a complete line of pipe beveling, Tube squaring, Duct Welding Machines & Severing machines, Clamshells for in-line cutting, & Flange facing are available for hire.</p>
          ...
          <div class="row top">
            ...
            <div class="col-md-12">
              <h3>ID MOUNT</h3>
              <p>With 6 models in our flagship 200 Series BevelMASTER® pipe beveling machines, along with several other portable machine tools and a variety of accessories that expand their cold pipe cutting and machining capabilities, Tri Tool can meet a broad range of requirements for beveling, counterboring, flange facing and single-point machining operations. </p>
            </div>
          ...
          <div class="row top">
            ...
            <div class="col-md-12">
              <!-- <h3>OD MOUNT </h3> -->
              <p><strong>TRIMAX®</strong> pipe lathes — Safest, most stable split frame lathe on the market today</p>
              <p>Tri Tool’s SeverMASTER 500 Series tube cutting machines deliver that and more in a compact sized piece of equipment that provides ultra-precision and the flexibility to be customized.</p>
              <p>Tri Tool’s 300 Series tube squaring machines are the perfect companion for autogenous orbital welding systems, delivering the high level of repeatable precision required by those systems for optimal weld results.</p>
            </div>
          ...
          <div class="row top">
            ...
            <div class="col-md-6">
              ...
              <iframe width="100%" height="315" src="https://www.youtube.com/embed/SIfAYHYcYxU" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>

            </div>

            <div class="col-md-6">

              <iframe width="100%" height="315" src="https://www.youtube.com/embed/Oct8wWR2LM8" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
...
<iframe width="100%" height="315" src="https://www.youtube.com/embed/blpGN0NDwHY" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>

    </div> -->

            <div class="col-md-12">

              <iframe width="100%" height="415" src="https://www.youtube.com/embed/x4pIFazKuKw" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
          ...
          <div class="row top">
            ...
            <div class="col-md-12">
              <p>For any rental requirements for pipe beveling machines, please <a class="cont" href="contact.php">contact us.</a> </p>
            </div>
