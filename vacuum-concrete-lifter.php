...
<head>
  ...
  <title>Vacuum concrete lifter | Rental</title>
...
<i class="fa fa-whatsapp my-float"></i>
  ...
  <section id="machinery-banner">
    ...
    <ul id="banner">
      ...
      <li>
        <img src="images/vacuum-concrete-lifter1.jpg" alt="Vacuum concrete lifter">

      </li>


      <li>
        <img src="images/vacuum-concrete-lifter2.png" alt="Vacuum concrete lifter">

      </li>
    </ul>
    <div class="slide-desc">
      <div class="cap-one">
        <h1> Vacuum concrete lifter </h1>
      </div>
    </div>
  </section>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-xl-9 col-lg-9 col-md-8">
          <h2 style="text-transform: uppercase;" id="product-tittle">Vacuum concrete lifter</h2>
          <p>To handle/load small and large sized construction elements, it is essential to have a vacuum lifter.</p>
          <p>Vacuum catchers enable the non-invasive lifting of pavement slabs, concrete pipes, curbs, palisades, or entire layers of cobblestone and other construction materials, thereby ensuring fast, comfortable and – importantly – safe and secure assembly.</p>
          <p>The use of lifters enhances safety while also improving the quality of the works executed on the building site and therefore, we present to you <b>Mickey</b> from <b>Catchshift</b>, <b>Poland</b>.</p>
          <div>

            <h3>Main advantages:</h3>
            <ul class="li-2">
              <li>Easy assembly owing to its compact design (assembly by one person) and convenient transport.</li>
              <li>Immediate suspension of transported elements (1 sec. For suction to the material).</li>
              <li>Easy, jointless laying of concrete elements (all side edges remain free).</li>
              <li>Light weight (weighs about 16kgs) and durable.</li>
              <li>The highest standard of work safety and has been certified in accordance with the EN 13155 standard (no risk of injury, with spine protection).</li>
            </ul>

            <p>Lifters are beneficial and can be deployed in Cobblestone (slabs, concrete slabs, paving slabs, unusual paving stones, curbs, etc.).</p>
          ...
          <div class="row top">
            ...
            <div class="col-md-12">
              <p>For any rental requirements for the <b>Vacuum concrete lifter</b> please <a class="cont" href="contact.php">contact us.</a> </p>
            </div>
