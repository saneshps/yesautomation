...
<head>
  ...
  <title>Floor Cleaning Machines | Automatic Vacuum Cleaner | Rental</title>
  ...
  <section id="machinery-banner">
    ...
    <ul id="banner">
      ...
      <li>
        ...
        <img src="images/cleaning-mach-ban1.png" alt="Floor Cleaning Machines rental">
      ...
      <li>
        ...
        <img src="images/cleaning-mach-ban2.png" alt=" Welding fixtures in UAE">
      ...
      <li>
        ...
        <img src="images/cleaning-mach-ban3.png" alt=" Floor Cleaning Machines Hire">
      ...
      <li>
        ...
        <img src="images/cleaning-mach-ban4.png" alt=" Welding fixtures in UAE">
      ...
      <li>
        ...
        <img src="images/cleaning-mach-ban5.png" alt=" Floor Cleaning Machines in UAE">
      ...
      <li>
        ...
        <img src="images/cleaning-mach-ban6.png" alt=" Welding fixtures in UAE">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-xl-9 col-lg-9 col-md-8">
          ...
          <h2 style="text-transform: uppercase;" id="product-tittle">Cleaning Machines</h2>



          <p>Cleanliness has always been an important factor and it becomes more crucial than ever in the current Covid-19 pandemic situation and we, at YES Automation, introduce a new name for Cleanliness, that’s right presenting the best in Swiss quality cleaning machines in UAE – Cleanfix.</p>

          <div>
            <h3>Areas of Application</h3>
            <ul class="li-2">
              <li>Backpacks for floor cleaning</li>
              <li>Steam vacuums used for kitchens</li>
              <li>Glass cleaning to spray extraction for a sofa</li>
              <li>Sun loungers</li>
              <li>Carpet cleaning</li>
              <li>Single-disc machines for floor polishing and deep cleaning</li>
              <li>Hand sweepers for indoor/outdoor cleaning</li>
              <li>Sweeper-vacuums and scrubber-dryers including ride-on floor cleaners</li>
            </ul>
            <p>Cleanfix has it all.</p>
            <p>These machines can be used at Homes, Offices, Warehouses, Car parks, shopping malls, or Hotels</p>
            <p>Cleaning machines and equipment are available for <strong>daily, weekly, and monthly rentals</strong>.</p>

          </div>

          <div class="row top">
            <div class="col-md-3">
              <p><a href="./dry-vaccum-cleaner.php"><b>Dry Vacuum Cleaner</b></a></p>
              <img src="images/cleaning-machines/2.png" class="img-responsive" alt="steam cleaning machines">

            </div>

            <div class="col-md-3">
              <p><a href="./wet-and-dry-vaccum-cleaner.php"><b>Wet &amp; Dry Vaccum Cleaner</b></a></p>
              <img src="images/cleaning-machines/10.png" class="img-responsive" alt="floor mopping machines">

            </div>

            <div class="col-md-3">
              <p><a href="./carpet-cleaning.php"><b>Carpet Cleaning</b></a></p>
              <img src="images/cleaning-machines/1.png" class="img-responsive" alt="upholstery cleaning machines">
            </div>
            <div class="col-md-3">
              <p><a href="./steam-vaccum-cleaner.php"><b>Steam Vacuum Cleaner</b></a></p>
              <img src="images/cleaning-machines/9.png" class="img-responsive" alt="single disc machine">
            </div>
          </div>

          <div class="row top">
            <div class="col-md-3">
              <p><a href="./scrubber-dryers.php"><b>Scrubber Dryer</b></a></p>
              <img src="images/cleaning-machines/7.png" class="img-responsive" alt="scrubber drier">
            </div>

            <div class="col-md-3">
              <p><a href="./ride-on-scrubber-dryer.php"><b>Ride-On Scrubber Dryer</b></a></p>
              <img src="images/cleaning-machines/5.png" class="img-responsive" alt="Ride-On Scrubber Dryer">
            </div>

            <div class="col-md-3">
              <p><a href="./single-disc-machines.php"><b>Single disc machines</b></a></p>
              <img src="images/cleaning-machines/8.png" class="img-responsive" alt="vacuum cleaner">
            </div>

            <div class="col-md-3">
              <p><a href="./sweeper-machines.php"><b>Sweeper machines</b></a></p>

              <img src="images/cleaning-machines/6.png" class="img-responsive" alt="sweeper machines">
            </div>
          </div>
