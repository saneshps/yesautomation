...
<head>
  ...
  <title>Single Disc Machines | Automatic Vacuum Cleaner | Rental</title>
  ...
  <section id="machinery-banner">
    ...
    <ul id="banner">
      ...
      <li>
        ...
        <img src="images/cleaning-mach-ban4.png" alt="Single Disc Machines in UAE">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-xl-9 col-lg-9 col-md-8">
          ...
          <h2 style="text-transform: uppercase;" id="product-tittle">Single Disc Machines</h2>
          <p>A large range of single disc machines suitable for effective and efficient maintenance cleaning for all kinds of floors. Available for daily, weekly and monthly hires. </p>

          <div class="row top">
            <div class="col-md-3">
              <p class="text-center"><b>Scrubby</b></p>
              <img src="images/cleaning-machines/scrubby.webp" class="img-responsive" alt="Single Disc Machines">
            </div>
            <div class="col-md-3">
              <p class="text-center"><b>FloorMac</b></p>
              <img src="images/cleaning-machines/floormac.webp" class="img-responsive" alt="Single Disc Machines">
            </div>
            <div class="col-md-3">
              <p class="text-center"><b>PowerDisc LS</b></p>
              <img src="images/cleaning-machines/powerdisc_ls.webp" class="img-responsive" alt="Single Disc Machines">
            </div>
            <div class="col-md-3">
              <p class="text-center"><b>Duo Speed</b></p>
              <img src="images/cleaning-machines/duospeed.webp" class="img-responsive" alt="Single Disc Machines">
            </div>
            <div class="col-md-3">
              <p class="text-center"><b>PowerDisc HS</b></p>
              <img src="images/cleaning-machines/powerdisc_hs.webp" class="img-responsive" alt="Single Disc Machines">
            </div>
            <div class="col-md-3">
              <p class="text-center"><b>R44-450 High-Speed</b></p>
              <img src="images/cleaning-machines/r44-450.webp" class="img-responsive" alt="Single Disc Machines">
            </div>

            <div class="col-md-3">
              <p class="text-center"><b>R44-120</b></p>
              <img src="images/cleaning-machines/r44-120.webp" class="img-responsive" alt="Single Disc Machines">
            </div>
            <div class="col-md-3">
              <p class="text-center"><b>R53-1100 Ultra High-Speed</b></p>
              <img src="images/cleaning-machines/r53-1100-uhs.webp" class="img-responsive" alt="Single Disc Machines">
            </div>
          </div>
