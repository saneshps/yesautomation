...
<head>
  ...
  <title>Scrubber Dryers | Automatic Vacuum Cleaner | Rental</title>
  ...
  <section id="machinery-banner">
    ...
    <ul id="banner">
      ...
      <li>
        ...
        <img src="images/cleaning-mach-ban3.png" alt="Scrubber Dryers in UAE">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-xl-9 col-lg-9 col-md-8">
          ...
          <h2 style="text-transform: uppercase;" id="product-tittle">Scrubber Dryers</h2>
          <p>Scrubber Dryers ideal for deep cleaning of all kinds of floors. Shapely, robust scrubber dryer with High cleaning power with forward and backwards traction for optimum cleaning results. Available for daily, weekly and monthly hires.</p>

          <div class="row top">
            <div class="col-md-4">
              <p class="text-center"><b>RA405 B</b></p>
              <img src="images/cleaning-machines/ra405b.webp" class="img-responsive" alt="Scrubber Dryer">
            </div>
            <div class="col-md-4">
              <p class="text-center"><b>RA395 IBC</b></p>
              <img src="images/cleaning-machines/ra395ibc.webp" class="img-responsive" alt="Scrubber Dryer">
            </div>
            <div class="col-md-4">
              <p class="text-center"><b>RA431 IBC</b></p>
              <img src="images/cleaning-machines/ra431e-b-ibc.webp" class="img-responsive" alt="Scrubber Dryer">
            </div>
            <div class="col-md-4">
              <p class="text-center"><b>RA505 IBCT</b></p>
              <img src="images/cleaning-machines/ra505.webp" class="img-responsive" alt="Scrubber Dryer">
            </div>
            <div class="col-md-4">
              <p class="text-center"><b>RA605-2</b></p>
              <img src="images/cleaning-machines/ra605-2.webp" class="img-responsive" alt="Scrubber Dryer">
            </div>
          </div>
