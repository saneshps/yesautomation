...
<head>
  ...
  <title>Dry Vacuum Cleaner | Automatic Vacuum Cleaner | Rental</title>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-xl-9 col-lg-9 col-md-8">
          ...
          <h2 style="text-transform: uppercase;" id="product-tittle">Dry Vacuum Cleaner</h2>
          <p>Small, quiet, agile, and powerful vacuum cleaners. High standard, durable, quality product that ensures positive performance. Extremely user-friendly models and available for rent for daily, weekly, and monthly needs. </p>

          <div class="row top">
            <div class="col-md-4">
              <p class="text-center"><b>S10</b></p>
              <img src="images/cleaning-machines/s10.webp" class="img-responsive" alt="Dry Vacuum Cleaner">
            </div>
            <div class="col-md-4">
              <p class="text-center"><b>S10 Plus</b></p>
              <img src="images/cleaning-machines/s10plus.webp" class="img-responsive" alt="Dry Vacuum Cleaner">
            </div>
            <div class="col-md-4">
              <p class="text-center"><b>S10 Plus HEPA</b></p>
              <img src="images/cleaning-machines/s10plus-hepa.webp" class="img-responsive" alt="Dry Vacuum Cleaner">
            </div>
            <div class="col-md-4">
              <p class="text-center"><b>S10 Plus SL</b></p>
              <img src="images/cleaning-machines/s10plus-sl.webp" class="img-responsive" alt="Dry Vacuum Cleaner">
            </div>
            <div class="col-md-4">
              <p class="text-center"><b>BS360 Eco</b></p>
              <img src="images/cleaning-machines/bs360-eco.webp" class="img-responsive" alt="Dry Vacuum Cleaner">
            </div>
          </div>
