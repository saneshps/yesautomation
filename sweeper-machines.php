...
<head>
  ...
  <title>Sweeper Machines | Automatic Vacuum Cleaner | Rental</title>
...
<i class="fa fa-whatsapp my-float"></i>
  ...
  <section id="machinery-banner">
    ...
    <ul id="banner">
      ...
      <li> <img src="images/cleaning-mach-ban5.png" alt="Sweeper Machines in UAE"> </li>
      <li> <img src="images/cleaning-mach-ban10.jpg" alt="Sweeper Machines in UAE"> </li>
    </ul>
    <div class="slide-desc">

      <div class="cap-one">

        <h1> Sweeper Machines </h1>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-xl-9 col-lg-9 col-md-8">
          ...
          <h2 style="text-transform: uppercase;" id="product-tittle"> Sweeping Machine  </h2>
          <p> A perfect solution to remove dust and dirt from all hard floors and roads. Ride-on sweeping machines
             are quite robust and efficient. Yes Automation has both battery operated and diesel operated sweeper
              machines on rent that can satisfy customers’ needs. The battery operated sweeping machines  are
               small enough to fit into an elevator and  is maneuverable enough to reach the tight corners.
                Industrial Sweepers can clean up to 20000 m2/h and is capable of collecting heavy dirt 
                on roads and sidewalks. These sweepers come with a suction hose that makes
                 cleaning hard-to-reach places easy. They are indispensable for occasional and maintenance
                  cleaning of hard surface areas. Available for daily, weekly and monthly hires.

            </p>

            <p> For more information, please feel to contact <a href="mailto:sales@yesautomation.ae"> sales@yesautomation.ae </a>
             or <a href="tel:+971502118507"> +971 50 211 8507</a>. </p>

          <div class="row top">
            <div class="col-md-3">
              <p class="text-center"><b>FlooBe 2</b></p>
              <img src="images/cleaning-machines/floobe2-totale-kurz.webp" class="img-responsive" alt="Sweeper Machines">
            </div>
            <div class="col-md-3">
              <p class="text-center"><b>HS770</b></p>
              <img src="images/cleaning-machines/hs770.webp" class="img-responsive" alt="Sweeper Machines">
            </div>
            <div class="col-md-3">
              <p class="text-center"><b>KS650 IBC</b></p>
              <img src="images/cleaning-machines/ks650-ibc.webp" class="img-responsive" alt="Sweeper Machines">
            </div>
            <div class="col-md-3">
              <p class="text-center"><b>KS1100 B</b></p>
              <img src="images/cleaning-machines/ks1100b.webp" class="img-responsive" alt="Sweeper Machines">
            </div>
            <div class="col-md-3 box-top">
              <p class="text-center"><b> STOUT MAX 170 INDUSTRIAL RIDE-ON SWEEPER </b></p>
              <img src="images/cleaning-machines/stout-max.webp" class="img-responsive" alt="Sweeper Machines">
            </div>
          </div>
