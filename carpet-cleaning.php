...
<head>
  ...
  <title>Carpet Cleaning | Automatic Vacuum Cleaner | Rental</title>
  ...
  <section id="machinery-banner">
    ...
    <ul id="banner">
      ...
      <li>
        ...
        <img src="images/cleaning-mach-ban1.png" alt="Carpet Cleaning">
    ...
    <div class="slide-desc">
      ...
      <div class="cap-one">
        ...
        <h1> Carpet Cleaning Machines</h1>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-xl-9 col-lg-9 col-md-8">
          ...
          <h2 style="text-transform: uppercase;" id="product-tittle">Carpet Cleaning Machines</h2>
          <p>Compact and lightweight carpet cleaning cleaners (TW 300 S and TW 412) ideal for basic cleaning of small to medium sized surfaces. For large areas, TW 600 and TW Compact carpet cleaners provides the perfect solution for cleaning corners, edges, and stairs. Available for daily, weekly, and monthly hires.</p>

          <div class="row top">
            <div class="col-md-4">
              <p class="text-center"><b>TW300S</b></p>
              <img src="images/cleaning-machines/tw300s.webp" class="img-responsive" alt="Carpet Cleaning">
            </div>
            <div class="col-md-4">
              <p class="text-center"><b>TW412</b></p>
              <img src="images/cleaning-machines/tw412.webp" class="img-responsive" alt="Carpet Cleaning">
            </div>
            <div class="col-md-4">
              <p class="text-center"><b>TW600</b></p>
              <img src="images/cleaning-machines/tw412.webp" class="img-responsive" alt="Carpet Cleaning">
            </div>
            <div class="col-md-4">
              <p class="text-center"><b>TW Compact</b></p>
              <img src="images/cleaning-machines/tw-compact.webp" class="img-responsive" alt="Carpet Cleaning">
            </div>
            <div class="col-md-4">
              <p class="text-center"><b>Hurrican</b></p>
              <img src="images/cleaning-machines/hurrican.webp" class="img-responsive" alt="Carpet Cleaner">
            </div>
          </div>
