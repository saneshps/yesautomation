...
<head>
  ...
  <title>Steam Vacuum Cleaner | Automatic Vacuum Cleaner | Rental</title>
  ...
  <section id="machinery-banner">
    ...
    <ul id="banner">
      ...
      <li>
        ...
        <img src="images/cleaning-mach-ban2.png" alt="Steam Vaccum Cleaners in UAE">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-xl-9 col-lg-9 col-md-8">
          ...
          <p>A perfect combination of Steam and vacuum in one model. This steam vacuum cleaner is particularly impressive in the commercial sector with its high performance and enormous capacity which in turn guarantees first-class cleaning results. Even the most stubborn dirt such as greasy kitchen stains can be removed with considerably less detergent and enables effortless and efficient work.</p>

          <div class="row top">
            <div class="col-md-4">
              <p class="text-center"><b>DS8-230 V/ 15 A</b></p>
              <img src="images/cleaning-machines/ds8.webp" class="img-responsive" alt="Steam Vacuum Cleaner">
            </div>
